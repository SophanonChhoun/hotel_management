...
class DashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.dashboard.dashboard',compact('payment','room_available','room_booked','customer','check_out','check_in','data','booking','total_room','room_type','customer_today','payment_today'));
    }
}
