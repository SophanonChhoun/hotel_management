/**
 * @api {get} /api/admin/property/list 1. List Property
 * @apiVersion 1.0.0
 * @apiName List Property
 * @apiGroup Property
 *
 * @apiUse GetHeader
 *
...
/**
 * @api {get} /api/admin/property/show/:property_id 2. Show Property
 * @apiVersion 1.0.0
 * @apiName Show Property
 * @apiGroup Property
 *
 * @apiUse GetHeader
 *
...
/**
 * @api {post} /api/admin/property/create 3. Create Property
 * @apiVersion 1.0.0
 ...
 * @apiParam {string} translations.name             Name of property
 * @apiParam {string} translations.lang             Language: `en`
 * @apiParam {string} [translations.address]        Address of property
 * @apiParam {string}  medias.content                Base64 image
 * @apiParam {integer}  media_id                    Media id if no upload new image. Value can be empty.
 * @apiParam {decimal} price                        Price of property
 *
...
/**
 * @api {post} /api/admin/property/update/:property_id 4. Update Property
 * @apiVersion 1.0.0
...
/**
 * @api {post} /api/admin/property/status/:property_id 5. Update Property Status
 * @apiVersion 1.0.0
 * @apiName Update Property Status
 * @apiGroup Property
 *
 * @apiUse PostHeader
 *
...
/**
 * @api {post} /api/admin/property/delete/:property_id 6. Delete Property
 * @apiVersion 1.0.0
