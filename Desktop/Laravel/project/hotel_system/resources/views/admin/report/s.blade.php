        ...
        <div class="row">
            <div class="col-xs-12 table-responsive">
                <table class="table table-striped">
                    <thead>
                    <tr>
                        <th style="max-width: 10px">Customer name</th>
                        <th style="max-width: 10px">Check in</th>
                        <th style="max-width: 10px">Check out</th>
                        <th style="max-width: 10px">Quantity</th>
                        <th style="max-width: 10px">Total</th>
                    </tr>
                    </thead>
                    <tbody>
