...
new Vue({
  ...
  methods: {
    ...
    getRoom: function getRoom() {
      ...
      axios.post("/admin/bookings/getRoom", this.data).then(function (response) {
        if (response) {
...
module.exports = __webpack_require__(/*! /Users/chhounsophanon/Desktop/web_project/hotel_management/Desktop/Laravel/project/hotel_system/resources/js/booking/create.js */"./resources/js/booking/create.js");
